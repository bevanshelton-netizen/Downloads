...
IZAKHONO_BACKUP_SOURCE_ALLOWLIST=/etc/izakhono,/var/lib/izakhono-data,/var/lib/izakhono-object,/var/lib/izakhono-queue,/var/lib/izakhono-runtime,/var/lib/izakhono-auth,/var/lib/izakhono-analytics,/var/lib/izakhono-notify,/var/lib/izakhono-ai-gateway,/var/lib/izakhono-code
