...
set "DEPLOY_SCRIPT=%STATE_DIR%\START-KORA-KIDS-ON-IZAKHONO.ps1"
set "SCRIPT_URL=https://raw.githubusercontent.com/bevanshelton-netizen/Downloads/main/owner-host/START-KORA-KIDS-ON-IZAKHONO.ps1"

if not exist "%STATE_DIR%" mkdir "%STATE_DIR%"
echo Downloading latest KORA KIDS owned-infrastructure deployment script...
...
echo.
if "%CODE%"=="0" (
  echo KORA KIDS IS LIVE ON IZAKHONO OWNED INFRASTRUCTURE.
) else (
  echo KORA KIDS deployment returned code %CODE%.
