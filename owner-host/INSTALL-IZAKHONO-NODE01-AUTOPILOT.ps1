...
if ($receiptRaw.Trim()) {
    ...
    @(
      ...
      "YHVH owner request: $($r.yhvh_owner_request_id)"
      "YHVH owner agent: $($r.yhvh_owner_agent)"
      "YHVH engine local: $($r.yhvh_engine_local)"
      "YHVH channel local: $($r.yhvh_channel_local)"
      "YHVH public HTTPS: $($r.yhvh_public_https)"
      "YHVH live claim: $($r.yhvh_live_claim)"
