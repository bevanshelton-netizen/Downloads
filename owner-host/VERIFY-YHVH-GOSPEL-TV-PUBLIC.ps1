...
if ($health.ok -ne $true -or $health.service -ne "yhvh-gospel-tv") {
    Fail 23 ("Health payload did not identify a healthy yhvh-gospel-tv service. Raw: {0}" -f $healthResponse.Content)
}
