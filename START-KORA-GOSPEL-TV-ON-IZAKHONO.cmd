...
echo Downloading latest YHVH GOSPEL TV deployment script...
...
echo.
if "%CODE%"=="0" (
  echo YHVH GOSPEL TV IS LIVE ON IZAKHONO OWNED INFRASTRUCTURE.
) else (
  echo YHVH GOSPEL TV deployment returned code %CODE%.
