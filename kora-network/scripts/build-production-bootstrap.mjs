...
const outputPath = join(outputDir, 'kora-production-bootstrap-schema19.sql');
...
parts.push(`\n-- ============================================================\n-- FINAL SCHEMA ASSERTION\n-- ============================================================\nDO $$\nDECLARE\n  v_schema integer;\nBEGIN\n  SELECT schema_version INTO v_schema\n  FROM public.platform_release_state\n  WHERE singleton = true;\n\n  IF COALESCE(v_schema, 0) <> 19 THEN\n    RAISE EXCEPTION 'KORA bootstrap incomplete: expected schema version 19, found %', COALESCE(v_schema, 0);\n  END IF;\nEND\n$$;\n\n-- KORA schema 19 bootstrap complete. Public launch remains fail-closed.\n`);
