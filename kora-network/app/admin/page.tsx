...
export default async function AdminHub() {
  ...
  return (
    <main>
      <section className="subHero"><div className="eyebrow">KORA OPERATIONS</div><h1>Network control.</h1><p>Moderation, rights, broadcast scheduling, creator revenue and commercial controls stay separated from creator and viewer workflows.</p></section>
      <section className="grid three">
        ...
        {profile.role === 'admin' ? <article className="panel"><h3>Rights operations</h3><p>Register and resolve copyright, music, performer and other distribution-rights disputes.</p><Link className="primary" href="/admin/rights">Open rights register</Link></article> : null}
      </section>
    </main>
  );
}
