  ...
  return (
    <div style={{marginTop:28,padding:22,borderRadius:24,border:'1px solid rgba(255,255,255,.14)',background:'rgba(10,23,43,.88)'}}>
      ...
      <div style={{display:'flex',gap:10,flexWrap:'wrap',marginTop:16}}>
        <a href={primaryUrl} style={{padding:'12px 18px',borderRadius:999,background:'linear-gradient(135deg,#f5c451,#e59d1d)',color:'#2d2108',fontWeight:900,textDecoration:'none'}}>Watch on IZAKHONO →</a>
      ...
      <p style={{margin:'14px 0 0',color:'#aebcd0',lineHeight:1.5,fontSize:14}}>If the owned hostname is not public yet, stay on KORA or use the public mirror. We keep external platforms as reach and resilience layers, not as the owner of the channel.</p>
    </div>
  );
}
