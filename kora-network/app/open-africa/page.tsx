...
const programmes = [
  ...
  {
    title: 'Nnwonkoro: Traditional Ghanaian Song',
    country: 'Ghana',
    category: 'Traditional Song & Heritage',
    duration: '16 sec',
    creator: 'Afimaame',
    license: 'CC BY-SA 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Traditional_Ghanaian_Song_(Nnwonkoro).webm',
    videoUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Traditional_Ghanaian_Song_(Nnwonkoro).webm',
    description: 'A concise window into Ghanaian vocal tradition and communal cultural expression.',
    tone: 'gold',
  },
  {
    title: 'Northern Ghana Drummer & Singer',
    country: 'Ghana',
    ...
    license: 'CC BY-SA 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:A_skillful_African_Drummer_and_singer_in_Northern_Ghana.webm',
    videoUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/A_skillful_African_Drummer_and_singer_in_Northern_Ghana.webm',
    description: 'A live drumming and vocal performance showcasing rhythm and performance craft from Northern Ghana.',
    tone: 'coral',
  },
  {
    title: 'Kiganda Dance',
    country: 'Uganda',
    category: 'Dance & Cultural Performance',
    duration: 'Short performance',
    creator: 'Denis Kasozi',
    license: 'CC BY 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Kiganda_dance.webm',
    videoUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Kiganda_dance.webm',
    description: 'A graceful Ugandan dance performance centred on expressive movement, rhythm and cultural pride.',
    tone: 'green',
  },
  {
    title: 'Intare Indashikirwa Traditional Dance',
    country: 'Rwanda',
    category: 'Dance & Heritage',
    ...
    license: 'CC BY 3.0',
    licenseUrl: 'https://creativecommons.org/licenses/by/3.0/',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Intare_Indashikirwa_-_Traditional_dance.webm',
    videoUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Intare_Indashikirwa_-_Traditional_dance.webm',
    description: 'A Rwandan traditional dance performance bringing heritage, choreography and ceremony to the KORA screen.',
    tone: 'blue',
  },
  {
    title: 'Aje Kogba',
