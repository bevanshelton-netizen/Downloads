...
const DATA_DIR = process.env.GOSPEL_TV_DATA_DIR || "/var/lib/izakhono-runtime/data/yhvh-gospel-tv";
...
const DEPLOYMENT_RECEIPT = process.env.YHVH_DEPLOYMENT_RECEIPT || "/var/lib/izakhono-deploy/yhvh-gospel-tv.json";
...
async function readDeploymentReceipt(){
  try{
    ...
    return {
      ...
      runtime_id:clean(x.runtime_id||x.app||"yhvh-gospel-tv",80),
...
async function controlStatus(){
  ...
  return {
    ok:true,
    service:"yhvh-gospel-tv-control",
    ...
    return json(res,200,{
      ...
      distribution:{
        ...
        external:[
          ...
          {provider:"GitHub Pages",role:"public-fallback",url:"https://bevanshelton-netizen.github.io/Downloads/yhvh-gospel-tv/",authoritative:false}
        ]
      }
    },{"access-control-allow-origin":"*"});
  }
