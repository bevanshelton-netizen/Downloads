...
install_component "IZAKHONO MAIL RELAY ADAPTER" "izakhono-mail-relay-adapter"
install_component "IZAKHONO AI GATEWAY NODE" "izakhono-ai-gateway-node"
install_component "IZAKHONO GPU COMPUTE NODE" "izakhono-gpu-compute-node"
install_component "IZAKHONO MODEL WORKER NODE" "izakhono-model-worker-node"
...
echo "MAIL_RELAY=INSTALLED_UNCONFIGURED"
echo "AI_GATEWAY=INSTALLED"
echo "GPU_COMPUTE=INSTALLED_CONTROL_PLANE"
echo "MODEL_WORKER=INSTALLED_ENGINE_PENDING"
echo "CODE=INSTALLED"
